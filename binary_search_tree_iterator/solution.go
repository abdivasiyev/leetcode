...
// the constructor. The pointer should be initialized to
// a non-existent number smaller than any element in the BST.
// boolean hasNext() Returns true if there exists
// a number in the traversal to the right of the pointer,
...
// That is, there will be at least a next number in the in-order traversal
// when next() is called.
